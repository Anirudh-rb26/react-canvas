...
const Page = () => {
    ...
    return (
        <div className="w-full h-screen flex flex-col items-center">
            ...
            <div className="h-[75vw] flex flex-col min-h-screen w-full items-center">
                {/* Header */}
                <div className="flex flex-col items-center mt-5">
                    <h1 className="text-custom-highlight text-3xl font-bold">Edit your Components Visually</h1>
                    <p className="mt-3 text-md text-white">React Canvas</p>
                </div>
                ...
                <div className="w-full h-full flex flex-row justify-center items-center p-5 gap-x-5">
                    ...
                    <div className="w-1/4 h-full flex flex-col">
                        <p className="text-[#93918a] font-medium">Select a Component to Customize</p>
            ...
            <div className="min-h-[35vw] w-full p-5 pb-10">
                <p className="text-[#93918a] font-medium">JSX Code</p>
                <Textarea
